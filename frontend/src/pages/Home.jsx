        ...
        <div className="xp-container">
          ...
          <div className="xp-footer-grid">
            ...
            <div className="xp-footer-brand">
              ...
              <p>
                India's high-trust institutional PropTech
                ecosystem delivering verified residential &
                commercial properties end-to-end with RERA
                compliance validation, digital title checks,
                and transparent escrow workflows.
              </p>

              <div className="xp-footer-address">
                <strong>Regional Technology Hubs:</strong>
                <span>
                  HQ: Indiranagar, Bengaluru, KA 560038
                </span>
                <span>
                  Offices: BKC Mumbai | Golf Course Road,
                  Gurugram
                </span>
              </div>

              <div className="xp-footer-rera">

                <div className="xp-footer-rera-icon">
                  <ShieldCheck size={17} />
                </div>

                <div>
                  <strong>
                    100% RERA Certified Operations
                  </strong>

                  <span>
                    All registered brokers and developers
                    adhere to RERA Act guidelines
                    (RERA/KA/RERA/125/2024).
                  </span>
                </div>
            ...
            <div className="xp-footer-column">
              ...
              <h4>Clients & Portals</h4>

              {footerLinks.portals.map((item) => (
                <button
                  type="button"
                  key={item}
                  onClick={() =>
            ...
            <div className="xp-footer-column xp-footer-app">

              <h4>Insights & App</h4>

              <p>
                Subscribe for monthly Indian market
                trend and launch previews.
              </p>

              <div className="xp-newsletter">
              ...
              <strong className="xp-download-title">
                Download Mobile Suite
              </strong>

              <div className="xp-app-buttons">
          ...
          <div className="xp-footer-bottom">
            ...
            <span>
              © 2025 Xevoprop Technologies Private
